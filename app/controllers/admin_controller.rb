class AdminController < ApplicationController
  ...
  def index
    if current_user.tem_perfil?('membro_comissao_cientifica') or current_user.tem_perfil?('coordenador_linha_pesquisa') or current_user.tem_perfil?('coordenador_comissao_cientifica') or current_user.tem_perfil?('membro_comissao_central')
