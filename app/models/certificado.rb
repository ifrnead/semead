class Certificado < ActiveRecord::Base
  ...
  TEXTOS = {
    ...
    :apresentacao_trabalho => "apresentou o trabalho <strong>[TRABALHO_TITULO]</strong>, na modalidade [TRABALHO_TIPO], no",
    ...
    :participou_minicurso => "participou do minicurso <strong>[MINICURSO_TITULO]</strong>, com carga-horária de <strong>[MINICURSO_CH] horas</strong>, no",
    :organizacao_evento => "participou da organização, atuando como [PARTICIPANTE_ATUACAO], do",
  ...
  def fragmentos
    {
      ...
      "PARTICIPANTE_ATUACAO" => (self.organizador.atuacao unless self.organizador.atuacao.blank?),
      "TRABALHO_TITULO" => (self.trabalho.titulo if self.trabalho),
      "TRABALHO_TIPO" => (self.trabalho.tipo_trabalho.to_s if self.trabalho),
